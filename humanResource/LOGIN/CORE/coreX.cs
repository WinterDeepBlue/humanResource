...
namespace humanResource.LOGIN.CORE
{/// <summary>
 ...
 /// </summary>
    public class CoreX
    {
        ...
        SqlConnection connectionString = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=H:\ACODE\dec3\2015\humanResource\humanResource\App_Data\vault.mdf;Integrated Security=True");
