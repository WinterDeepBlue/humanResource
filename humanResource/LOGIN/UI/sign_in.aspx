<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sign_in.aspx.cs"  %>
            ...
            <div class="wrap_user">
             ...
             <asp:TextBox ID="TextBox2" Type="password" class="form-control" style="margin-top: 10px;" runat="server" placeholder="p a s s w o r d"></asp:TextBox>
                <div style="float:left; width: 399px; height: 26px; margin-top:5px;">
                    <p style="font-size:12px;color:white;text-align:center;opacity:0.8;">forgot your passwordd?</p>
                </div>
              ...
              <asp:Button class="btn btn-default" ID="Button2" runat="server" Text="sign_in" Visible="false" />                
